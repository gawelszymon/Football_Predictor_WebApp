...
if response.status_code == 200:
    ...
    for match in matches:
        ...
        # Adjust team names for special cases
        ...
        # Debugging output to verify the URLs being generated
        print(f"Original Team 1: {match['team1']} | URL Part: {team1_url_part}")
        print(f"Original Team 2: {match['team2']} | URL Part: {team2_url_part}")

        match_url = f"https://www.transfermarkt.pl/{team1_url_part}_{team2_url_part}/statistik/spielbericht/{match['match_id']}"

        # Print the generated URL to verify it's correct
